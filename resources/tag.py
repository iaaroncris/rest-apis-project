...
class LinkTagsToItem(MethodView):
    ...
    def post(self, item_id, tag_id):
        ...
        try:
            ...
            abort(400, message="Error occurred while inserting the tag.")
...
class Tag(MethodView):
    ...
    @blp.response(202, description="Deletes a tag if no item s tagged with it.", example={"message": "tag deleted."})
